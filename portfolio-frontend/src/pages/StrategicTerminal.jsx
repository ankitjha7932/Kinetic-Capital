...
const STRATEGIC_SUGGESTIONS = [
  {
    ...
    icon: <Scale size={12} />,
    query:
      "Is the current P/E ratio justifiable given the historical average and industry peers?",
  },
  {
    label: "Macro Impact",
    icon: <Globe size={12} />,
    query:
      "How are the latest West-Asian geopolitical tensions specifically impacting this sector's sentiment?",
  },
  {
    label: "Dividend Health",
    icon: <ShieldCheck size={12} />,
    query:
      "Analyze the cash flow statement. Is the current dividend payout sustainable for the next 2 years?",
  },
  {
    label: "Earnings Trend",
    icon: <Activity size={12} />,
    query:
      "Based on the last 4 quarters of Profit & Loss, is the bottom-line growth accelerating or plateauing?",
  },
];
...
export default function StrategicTerminal() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      text: `### Strategic Terminal Online\nMonitoring target: **${symbol}**. Quantitative core active and monitoring NSE/BSE feeds.`,
    },
  ]);
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-200 font-sans overflow-hidden">
      {/* LEFT SIDEBAR: Pro Terminal Look */}
      ...
      <div className="flex-1 flex flex-col relative bg-slate-950">
        ...
        <div className="p-6 flex justify-between items-center border-b border-white/5 bg-slate-950/40 backdrop-blur-md z-10">
          ...
          <div className="flex gap-4">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-900 border border-white/5 rounded-lg">
        ...
        <div className="p-8 bg-slate-950/80 backdrop-blur-2xl border-t border-white/5">
          <div className="max-w-3xl mx-auto">
            {/* SUGGESTION CHIPS (Replacing the MCQ grid) */}
